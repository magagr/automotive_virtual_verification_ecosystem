...
These enablers also need to be mapped to a{n overall} company strategy in order to facilitate wider adoption. 
...
A pilot demonstrating a strong value chain that can support 
{a key use cases would be an effective}
