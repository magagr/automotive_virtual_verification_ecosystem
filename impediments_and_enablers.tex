...
\begin{quote}
``No one will ever have all the IPs\footnote{Intellectual property, i.e. creations of the mind, including industry designs, patents. Here: hardware/software components traded between ecosystem actors} at any given time. So new IPs will always have to be created/modeled, costing time and money. The question is: who will model it?''
