...
\begin{itemize}
    ...
    \item \del{Bootstrap the ecosystem}\eric{Bring in line with Intro and Sidebar 1}\magnus{I made a stab} \chg{by sharing}{Share} knowledge and clarify\del{ing} the \ins{virtual verification ecosystem} actor--role mapping \cite{kilamo2012proprietary}.
\end{itemize}
