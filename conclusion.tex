...
the ecosystem for model sharing and virtual verification \ins{for automotive software development}.
As the emerging ecosystem is still in its early stage,
we share a map of impediments and enablers we found most useful to plan the activities needed to \chg{bring about}{achieve} the technical and collaborative benefits.
