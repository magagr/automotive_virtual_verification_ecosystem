...
\eric{since we explain it here, I suggest to highlight it (italics), and then use this exact string whereever we refer to the ecosystem, including title.}\magnus{I agree; proposed a title} \cite{Knauss2014d} involves suppliers of models and tools, suppliers of hardware and software, and users, aiming to leverage the benefits of virtualization and MDE (the technological platform).
