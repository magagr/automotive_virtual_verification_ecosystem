...
\begin{tcolorbox}
Ecosystem itself, based on previous publication
\end{tcolorbox}
...
\subsubsection{Managing Software Platforms and Ecosystems: Call for Papers}
...
The workshop was conducted after the interviews were completed, and included personnel from engineering (advanced development) and R&D at the OEM, a guest speaker from ARM, and the faculty members co-authoring this report. The objective of the workshop was to supplement information gathered from the interview sessions by having a focused 2-day discussion on enterprise-scale deployment of MCU/ECU mixed fidelity simulation models, and tools and processes for control system and plant development. The workshop focused on the benefits and challenges of deploying VP technology to improve software development processes within an automotive OEM (facilitated by two half-day workshop brainstorming sessions).
