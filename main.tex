...
\begin{itemize}
    \item Vision for new ways of working, section \ref{sec:benefits}
    \item Concrete impediments an enablers, sections \ref{sec:impediments}\&\ref{sec:enablers}
    \item Strategy to implement in automotive value-chain, section \ref{sec:conclusion}
\end{itemize}
...
\begin{tcolorbox}[float*,title=Ecosystem,width=\textwidth]
\includegraphics[width=\textwidth]{figures/ecosys}
\tcblower
\input{box_ecosystem}
\end{tcolorbox}

\begin{tcolorbox}[float*,title=Technology background,width=\textwidth]
...
\begin{tcolorbox}[float,title=Map of Impediments and Enablers]
\includegraphics[width=\linewidth]{figures/results_map}
%\caption{Map of Impediments and Enablers}
\end{tcolorbox}
