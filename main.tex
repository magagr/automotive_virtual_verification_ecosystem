...
\author{S. Magnus \AA gren,~Eric Knauss, Paulo Giusto, Grant Soremekun, Rogardt Heldal, Daniela Damian% <-this % stops a space
...
\begin{abstract}
Virtual verification promises huge gains in productivity of automotive systems development, especially if supported by shared modelling throughout the automotive ecosystem. 
This would allow to share accurate models of ECUs and their components long before the hardware becomes available and use them for verification.
Yet, adoption of such techniques has proven difficult. 
By mapping out benefits, critical impediments, and crucial enablers, we provide help to overcome such difficulties.
%150 word limit
%
%Submission
%
...
% Figures
\begin{tcolorbox}[float*,title=\fig{fig:ecosys} Ecosystem Background,width=\textwidth, lower separated=false]
...
\begin{tcolorbox}[float*,title=\fig{fig:tech} Technology Background,width=\textwidth]
...
\input{benefits}
\input{impediments_and_enablers}
