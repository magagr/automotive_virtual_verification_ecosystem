...
\title{Impediments and Enablers for the Automotive Virtual Verification Ecosystem}
...
\begin{abstract}
Virtual verification promises measurable gains in productivity of automotive systems development, especially if supported by %the
shared modeling of ECUs (electronic control unit) and their components across the automotive supply chain, and throughout the software development process, long before ECUs and components become available as silicon.
...
% Figures
\input{figures.tex} % need .tex for disambiguation
...
\section{Summary and Recommendations}\label{sec:conclusion}
\input{conclusion}

% The Computer Society usually uses the plural form
\section*{Acknowledgments}
The authors would like to thank all participants in interviews and workshop as well as the NECSIS research network for %providing funding and a platform that supported 
supporting this international collaboration.
