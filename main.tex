...
\begin{abstract}
Virtual verification promises measurable gains in productivity of automotive systems development, especially if supported by the shared modelling of ECUs (electronic control unit) and their components across the automotive ecosystem and supply chain, and throughout the software development process, long before ECUs and components become available as silicon.
