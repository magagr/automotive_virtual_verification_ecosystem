...
This would allow \ins{ecosystem actors (manufacturers and suppliers)} to share accurate models of ECUs and their components long before the hardware becomes available and use them for verification.
...
\begin{tcolorbox}[float*,title=\sidebar{map:tech} Technology Background,width=\textwidth]
