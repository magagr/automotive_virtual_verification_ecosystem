...
\begin{abstract}
Virtual verification promises measurable gains in productivity of automotive systems development, especially if supported by the shared modelling of ECUs and their components across the automotive ecosystem and supply chain, and throughout the SW development process, long before ECUs and components become available as silicon.
Yet, large scale adoption of virtual verification has proven difficult. By
describing benefits, critical impediments, and crucial enablers, we provide help for overcoming such difficulties.
