...
For example, if suppliers are encouraged to provide models and virtual assets to their customers (other suppliers and OEMs\ins{, etc.}) early in the \ins{design} process,
