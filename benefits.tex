...
Hardware test benches (see sidebar \ref{bar:tech}) are typically a heavily shared resource, resulting in scheduling conflicts and other logistic difficulties.
...
%,\chg{in turn reducing}{rectifying these} scheduling problems.
...
\subsubsection*{Uncovering More Design Errors}
Virtual testing can allow engineers to monitor, control, and observe the testing environment in a more comprehensive manner than currently possible on physical hardware.
