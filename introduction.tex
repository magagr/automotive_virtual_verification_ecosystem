...
\IEEEPARstart{T}{he} development of automotive control architectures is increasingly dependent on %the use of 
modeling and simulation. %technologies. 
Historically, these techniques are often applied reactively and only later in the development process. Automotive OEMs (original equipment manufacturers) typically act %mainly 
